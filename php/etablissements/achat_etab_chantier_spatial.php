	...
	if( $construction == 0)
		{
			...
			($oriniastock >= $prix_orinia))
				{	
						...
						$req_up_construc=$bdd->prepare('INSERT INTO construction_etab (joueur, etablissement, post, temps) VALUES (:joueur, :etablissement, :post, :temps)');
						$req_up_construc->execute(array('joueur' => $id_membre, 'etablissement' => $post, 'post'=> $post, 'temps'=> $delai));
...
header('Location: '.pathView().'etablissements/etab_hangar_spatial.php');
?>
